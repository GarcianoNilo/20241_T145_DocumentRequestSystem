...
import './componentsCss/StepsPanel.css';
    ...
    <div className="steps-panel">
      ...
      <MDBCard className="step-card mb-3">
        <MDBCardBody className="d-flex align-items-center">
          <MDBIcon fas icon="mouse-pointer" size="2x" className="me-3 text-primary" />
          <div>
            <h5>Step #1</h5>
      ...
      <MDBCard className="step-card mb-3">
        <MDBCardBody className="d-flex align-items-center">
          <MDBIcon fas icon="file-alt" size="2x" className="me-3 text-primary" />
          <div>
            <h5>Step #2</h5>
      ...
      <MDBCard className="step-card">
        <MDBCardBody className="d-flex align-items-center">
          <MDBIcon fas icon="calendar-check" size="2x" className="me-3 text-primary" />
          <div>
            <h5>Step #3</h5>
